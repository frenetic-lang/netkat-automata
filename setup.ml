...
(* OASIS_START *)
(* DO NOT EDIT (digest: 0efb0b7c27d432adb76b2b0a0459f3a5) *)
(*
...
let setup_t =
  {
            ...
            [
               ...
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "Measure.ml"});
               Executable
                 ({
                     cs_name = "compile";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = false; exec_main_is = "Compile.ml"});
               Executable
                 ({
                     cs_name = "printpolicy";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = false; exec_main_is = "PrintPolicy.ml"});
               Executable
                 ({
                     cs_name = "printtopo";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = false; exec_main_is = "PrintTopo.ml"});
               Executable
                 ({
                     cs_name = "natetomark";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = false; exec_main_is = "NateToMark.ml"});
               Executable
                 ({
                     cs_name = "termsize";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = false; exec_main_is = "TermSize.ml"});
               Executable
                 ({
                     cs_name = "topotomininet";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   {exec_custom = false; exec_main_is = "TopoToMininet.ml"});
               Executable
                 ({
                     cs_name = "jsontopolicy";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   {exec_custom = false; exec_main_is = "JSONToPolicy.ml"})
            ];
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "p\173\016H\187\004y\1518n\148\229h\192\169\222";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
