...
The input to the automaton is a string of the form
\begin{align*}
\alpha_0 p_1 \pdup p_2 \pdup \cdots \pdup p_m \in \At\cdot(P\cdot\pdup)\star\cdot P.
\end{align*}
The automaton starts with its read head pointing to $\alpha_0$.
