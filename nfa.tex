...
\subsection*{Antimirov Derivative (L2R)}
...
up to ACI, there are at most exponentially many NetKAT derivatives accessible from $e$, where $n$ is the
...
\begin{lemma}
\label{eq:Deltacl}
$\Delta_{\alpha p\pdup}(e) \subs \cl e$. (Not quite right)
\end{lemma}
