...
(* OASIS_START *)
(* DO NOT EDIT (digest: 8413847a62a9f54c3a320749c09a4243) *)
(*
...
let setup_t =
  {
            ...
            [
               Library
                 ({
                   ...
                   {
                      lib_modules =
                        ["Decide_Util"; "Decide_Ast"; "Decide_Bisimulation"];
                      lib_pack = false;
     ...
     oasis_version = "0.4.1";
     oasis_digest = Some "\180\191\006\201>\031\224@3\020v\228\014\136\2045";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
